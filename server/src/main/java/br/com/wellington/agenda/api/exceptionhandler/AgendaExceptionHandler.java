package br.com.wellington.agenda.api.exceptionhandler;
...
import br.com.wellington.agenda.api.service.exception.AgendaNegocioException;
...
public class AgendaExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({AgendaNegocioException.class})
	public ResponseEntity<Object> handleAgendaNegocioException(AgendaNegocioException exception,
			WebRequest request) {
